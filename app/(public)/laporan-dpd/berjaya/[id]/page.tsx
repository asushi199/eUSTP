...
export default async function DpdBerjayaPage({
  params,
  searchParams,
}: {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-20 text-center sm:px-8">
      ...
      <p className="mt-2 text-graphite">
        Laporan DPD anda (#{id}) telah disimpan. Anda boleh melihat dan mencetak
        laporan sekarang.
      </p>
      {amaran && (
      ...
      <div className="mt-8 flex justify-center gap-3">
        <Link href={`/laporan-dpd/${id}/cetak`} className="btn-primary">
          Lihat Laporan
        </Link>
        <Link href="/laporan-dpd" className="btn-outline-ink">
          Hantar Lagi
        </Link>
      </div>
    </div>
