...
export default async function AdminDirektoriPegawaiPage() {
  ...
  return (
    <>
      ...
      <h1 className="mt-2 text-2xl font-semibold tracking-tight">Pegawai USTP</h1>
      <p className="mt-1 text-sm text-graphite">
        Senarai pegawai untuk Direktori USTP. Foto: laluan public/ (cth.
